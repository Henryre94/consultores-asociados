        ...
        return $form
            ->schema([
                Section::make('Datos generales')
                    ->description('En la siguiente seccion se encontraron los datos generales de una familia o persona')
                    ->columns([
                        'default' => 1,
                        'sm' => 2
                    ])
                    ->schema([
                        Section::make()
                            ...
                            ->schema([
                                Forms\Components\TextInput::make('ficha_no')
                                    ->required()
                                    ->label('Ingresa el numero de ficha / Si ya hay un registro con ese numero de ficha se asignara los datos correspondientes')
                                    ->numeric()
                                    ->reactive()
                                    ->afterStateUpdated(function ($state, callable $set) {
                                        $record = Diligenciamiento::where('ficha_no', $state)->first();
                                        if ($record) {
                                            $set('fecha_operacion', $record->fecha_operacion);
                                            $set('gps_latitude', $record->gps_latitude);
                                            $set('gps_longitude', $record->gps_longitude);
                                            $set('gps_altitude', $record->gps_altitude);
                                            $set('pdf', $record->pdf);
                                            $set('version', $record->version);
                                            $set('fuente', $record->fuente);
                                            $set('legal_declaration', $record->legal_declaration);
                                            $set('departamento', $record->departamento);
                                            $set('municipio', $record->municipio);
                                            $set('centro_poblado', $record->centro_poblado);
                                            $set('direccion', $record->direccion);
                                            $set('barrio', $record->barrio);
                                            $set('informante_calificado', $record->informante_calificado);
                                            $set('declaracion_juramentada', $record->declaracion_juramentada);
                                            $set('primer_nombre', $record->primer_nombre);
                                            $set('segundo_nombre', $record->segundo_nombre);
                                            $set('primer_apellido', $record->primer_apellido);
                                            $set('segundo_apellido', $record->segundo_apellido);
                                            $set('excepciones', $record->excepciones);
                                            $set('firma', $record->firma);
                                            $set('no_firma_por', $record->no_firma_por);
                                            $set('correo_electronico', $record->correo_electronico);
                                            $set('telefono_contacto', $record->telefono_contacto);
                                            $set('tipo_vivienda', $record->tipo_vivienda);
                                            $set('material_pisos', $record->material_pisos);
                                            $set('material_paredes', $record->material_paredes);
                                            $set('servicios_publicos', $record->servicios_publicos);
                                            $set('cuartos', $record->cuartos);
                                            $set('grupos_presupuesto', $record->grupos_presupuesto);
                                            $set('hogar_numero', $record->hogar_numero);
                                            $set('de', $record->de);
                                            $set('vivienda_ocupada', $record->vivienda_ocupada);
                                            $set('tipo_sanitario', $record->tipo_sanitario);
                                            $set('agua_consumo', $record->agua_consumo);
                                            $set('agua_7_dias', $record->agua_7_dias);
                                            $set('agua_24_horas', $record->agua_24_horas);
                                            $set('ubicacion_sanitario', $record->ubicacion_sanitario);
                                            $set('sanitario_tipo', $record->sanitario_tipo);
                                            $set('agua_beber', $record->agua_beber);
                                            $set('eliminacion_basura', $record->eliminacion_basura);
                                            $set('tiene_cocina', $record->tiene_cocina);
                                            $set('ubicacion_cocina', $record->ubicacion_cocina);
                                            $set('combustible_cocina', $record->combustible_cocina);
                                            $set('bienes_servicios', $record->bienes_servicios);
                                            $set('gasto_alimentacion', $record->gasto_alimentacion);
                                            $set('gasto_transporte', $record->gasto_transporte);
                                            $set('gasto_educacion', $record->gasto_educacion);
                                            $set('gasto_salud', $record->gasto_salud);
                                            $set('gasto_servicios_publicos', $record->gasto_servicios_publicos);
                                            $set('gasto_celular', $record->gasto_celular);
                                            $set('gasto_arriendo', $record->gasto_arriendo);
                                            $set('gasto_otros', $record->gasto_otros);
                                            $set('gasto_suma', $record->gasto_suma);
                                            $set('tiempo_habitando', $record->tiempo_habitando);
                                            $set('eventos_afectado', $record->eventos_afectado);
                                            $set('total_personas', $record->total_personas);
                                            $set('total_documentos_validos', $record->total_documentos_validos);
                                            $set('mujeres_8_mas', $record->mujeres_8_mas);
                                            $set('participo_elecciones', $record->participo_elecciones);
                                            $set('lugar_votacion', $record->lugar_votacion);
                                        } else {
                                            $set('fecha_operacion', '');
                                            $set('gps_latitude', '');
                                            $set('gps_longitude', '');
                                            ...
                                            $set('direccion', '');
                                            $set('barrio', '');
                                            $set('informante_calificado', '');
                                            $set('declaracion_juramentada', '');
                                            $set('primer_nombre', '');
                                            $set('segundo_nombre', '');
                                            $set('primer_apellido', '');
                                            ...
                                            $set('tipo_vivienda', '');
                                            $set('material_pisos', '');
                                            $set('material_paredes', '');
                                            $set('servicios_publicos', '');
                                            $set('cuartos', '');
                                            $set('grupos_presupuesto', '');
                                            $set('hogar_numero', '');
                                            $set('de', '');
                                            $set('vivienda_ocupada', '');
                                            $set('tipo_sanitario', '');
                                            $set('agua_consumo', '');
                                            $set('agua_7_dias', '');
                                            $set('agua_24_horas', '');
                                            $set('ubicacion_sanitario', '');
                                            $set('sanitario_tipo', '');
                                            $set('agua_beber', '');
                                            $set('eliminacion_basura', '');
                                            $set('tiene_cocina', '');
                                            $set('ubicacion_cocina', '');
                                            $set('combustible_cocina', '');
                                            $set('bienes_servicios', '');
                                            $set('gasto_alimentacion', '');
                                            $set('gasto_transporte', '');
                                            $set('gasto_educacion', '');
                                            $set('gasto_salud', '');
                                            $set('gasto_servicios_publicos', '');
                                            $set('gasto_celular', '');
                                            $set('gasto_arriendo', '');
                                            $set('gasto_otros', '');
                                            $set('gasto_suma', '');
                                            $set('tiempo_habitando', '');
                                            $set('eventos_afectado', '');
                                            $set('total_personas', '');
                                            $set('total_documentos_validos', '');
                                            $set('mujeres_8_mas', '');
                                            $set('participo_elecciones', '');
                                            $set('lugar_votacion', '');
                                        }
                                    }),
                            ]),
                        ...
                        Forms\Components\Textarea::make('legal_declaration')
                            ->label('La negativa de suministrar la totalidad de la información solicitada impedirá su registro en la base de datos Municipal...')
                            ->required()
                            ->maxLength(65535)
                            ->columnSpanFull()
                            ->visible(fn ($livewire) => $livewire instanceof \Filament\Resources\Pages\EditRecord),

                        $record && $record->foto_sticker && $status ?
                            ...
                            ->disk('public')
                            ->directory('images'),
                        $record && $record->foto_unidad_residencial && $status ?
                ...
                Section::make('Datos personales')
                    ->description('Aqui se asignan los datos personales de cada persona')
                    ->schema([
