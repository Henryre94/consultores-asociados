...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('diligenciamientos', function (Blueprint $table) {
            ...
            $table->string('foto_sticker')->nullable();
            ...
            $table->integer('tiempo_habitando')->nullable();
            $table->json('eventos_afectado')->nullable();
            ...
            $table->json('limitantes_permanentes')->nullable();
