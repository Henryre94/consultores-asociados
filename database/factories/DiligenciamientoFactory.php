...
class DiligenciamientoFactory extends Factory
{
    ...
    {
        return [
            'usuario_movil' => $this->faker->userName,
            'fecha_operacion' => $this->faker->date,
            'gps_latitud' => $this->faker->latitude,
            'gps_longitud' => $this->faker->longitude,
            'gps_altitud' => $this->faker->randomFloat(2, 0, 3000),
            'pdf' => $this->faker->fileExtension,
            'version' => $this->faker->numberBetween(1, 10),
            'fuente' => $this->faker->word,
            'declaracion_legal' => $this->faker->sentence,
            ...
            'fecha_diligenciamiento' => $this->faker->date,
            ...
            'puesto_votacion' => $this->faker->word,
            'tipo_ab' => $this->faker->word,
            ...
            'tipo_discapacidad' => $this->faker->word,
