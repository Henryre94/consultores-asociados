...
class DiligenciamientoFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'centro_poblado' => $this->faker->randomElement(['Cabecera Municipal', 'La Loma','Potrenillo','Cuatro Vientos','El Vallito','El Carmen']),
            ...
            'tipo_vivienda' => $this->faker->randomElement(['Casa', 'Cuarto','Apartamento','Vivienda Indígena','El Carmen']),
            'material_paredes' => $this->faker->word,
            'material_pisos' => $this->faker->word,
            'servicios_publicos' => $this->faker->randomElement(['Energía Electrica', 'Alcantarillado','Gas natural domiciliario']),
            ...
            'total_personas' => $this->faker->numberBetween(1, 2,3,4,5,6),
            ...
            'sabe_leer_escribir' => $this->faker->boolean,
            'actualmente_estudia' => $this->faker->boolean,
