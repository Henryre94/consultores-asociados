...
<html lang="es">
    <head>
        ...
        td {
            padding: 0; /* Para eliminar espacio extra en las celdas */
        }
        ...
        <div>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                @if (file_exists(public_path('storage/images/consultores_icon.jpg')))
                                    <img src="storage/images/consultores_icon.jpg" alt="Consultores Asociados S.A.S. Logo" style="width: auto; height: 12rem;">
                                @else
                                    <div></div>
                                @endif
                            </td>
                            <td style="text-align: center;">
                                @if (file_exists(public_path('storage/images/alcaldia_icon.jpg')))
                                    <img src="storage/images/alcaldia_icon.jpg" alt="Mapa de la alcaldia" style="width: auto; height: 12rem;">
                                @else
                                    <div></div>
                                @endif
                            </td>
                            <td style="text-align: center;">
                                @if (file_exists(public_path('storage/images/departamento_map.jpg')))
                                    <img src="storage/images/departamento_map.jpg" alt="Mapa de la alcaldia" style="width: auto; height: 12rem;">
                                @else
                                    <div></div>
                                @endif
                            </td>
            ...
            <div style="margin-top: 2rem; border-bottom: 2px solid #A0AEC0; padding-bottom: 1rem">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td style="width: 60%; font-size: 1.0rem;">Población ajustada por omisión en cabecera municipal:  <span class="poblacion-etnica-valor"> 6.922</span></td>
                        <td><img src="storage/images/building.png" alt="Logo Hombre" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                    </tr>
                    <tr>
                        <td style="width: 60%; font-size: 1.0rem;">Población ajustada por omisión en centros poblados y rural disperso: <span class="poblacion-etnica-valor"> 30900</span></td>
                        <td><img src="storage/images/home.png" alt="Logo Hombre" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                    </tr>
                </table>
                        ...
                        <div class="graphic-container">
                            <table style="width: 100%; margin-top: 1rem; margin-bottom: 1rem;">
                                <tr>
                                    ...
                                    <td style="font-size: 1.0rem; font-weight: bold; text-align: left;"> {{$omisionCabeceraPercentage}}% </td>
                                    <td style="font-size: 1.0rem; font-weight: bold; text-align: right;"> {{$omisionPobladoPercentage}}% </td>
                                </tr>
                                <tr>
                                    <td style="width: 20%">
            ...
            <div>
                <table style="width: 100%">
                    <tr>
                        <td style="font-size: 1.0rem; font-weight: bold; margin-bottom: 0.5rem; padding-bottom: 0.5rem">Lugar de nacimiento</td>
                    </tr>
                    <tr>
                        <td>
                             <img src="storage/images/woman.png" alt="Logo Mujer" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;">
                    ...
                    <tr>
                        <td>
                             <img src="storage/images/man.png" alt="Logo Mujer" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;">
                        </td>
                        <td class="poblacion-etnica-valor">1%</td>
                        <td class="poblacion-etnica-valor">1%</td>
                        <td class="poblacion-etnica-valor">1%</td>
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <table style="width: 100%; height: margin-top: 1rem; margin-bottom: 1rem;">
                                                <tr>
                                                    <td style="font-size: 1.0rem; font-weight: bold;"><img src="storage/images/building-apartments.png" alt="Edificio Apartamentos" style="width: 8rem; height: 8rem; object-fit: cover; margin-bottom: 0.5rem;">
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td style="padding-left: 1rem;">
                                            <table style="width: 100%; margin-bottom: 1rem;">
                                                <tr>
                                                    <td style="font-size: 2.0rem; font-weight: bold; padding: 1rem;">12.314</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <p style="font-size: 1.0rem; font-weight: bold; color: #4A5568; padding-left: 1rem;">Total unidades de vivienda*
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 2.0rem; font-weight: bold;padding: 1rem;">8931</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <p style="font-size: 1.0rem; font-weight: bold; color: #4A5568; padding-left: 1rem;">
                ...
                <div>
                    ...
                    <table style="width: 100%; margin-bottom: 2rem;">
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td><img src="storage/images/house.png" alt="Logo Casa" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;">
                                        </td>
                                        <td style="padding-left: 0.5rem">
                                            <table>
                                                <tr><td style="font-size: 1rem;">Casa</td></tr>
                                                <tr><td class="poblacion-etnica-valor-tipo-vivienda">10480</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td><img src="storage/images/building-apartments.png" alt="Logo Mujer" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td style="padding-left: 0.5rem">
                                            <table>
                                                <tr><td style="font-size: 1rem;">Apartamento</td></tr>
                                                <tr><td class="poblacion-etnica-valor-tipo-vivienda">10480</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td><img src="storage/images/bed.png" alt="Logo Cama" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td style="padding-left: 0.5rem">
                                            <table>
                                                <tr><td style="font-size: 1rem;">Cuarto</td></tr>
                                                <tr><td class="poblacion-etnica-valor-tipo-vivienda">10480</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                    ...
                    <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td><img src="storage/images/casa-etnica.png" alt="Logo Mujer" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td style="padding-left: 0.5rem">
                                            <table>
                                                <tr><td style="font-size: 1rem;">Casa etnica</td></tr>
                                                <tr><td class="poblacion-etnica-valor-tipo-vivienda">10480</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td><img src="storage/images/house.png" alt="Logo Mujer" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td style="padding-left: 0.5rem">
                                            <table>
                                                <tr><td style="font-size: 1rem;">Otro</td></tr>
                                                <tr><td class="poblacion-etnica-valor-tipo-vivienda">10480</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td style="width: 15%">
                                <table>
                                    <tr>
                                        <td><img src="storage/images/house.png" alt="Logo Mujer" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td><img src="storage/images/family-four.png" alt="Logo Mujer" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                                <table style="font-size: 1rem;">
                                    ...
                                    <tr>
                                        <td>
                                            Corresponde a los grupos de personas residentes en viviendas ocupadas con personas
                                            presentes
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <table style="width: 100%; margin-bottom: 2rem;">
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td><img src="storage/images/woman.png" alt="Logo Mujer" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td style="padding-left: 1rem">
                                            <table>
                                                <tr class="poblacion-etnica-valor-tipo-vivienda"><td>11,6%</td></tr>
                                                <tr><td>UNA PERSONA</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td><img src="storage/images/woman-man.png" alt="Logo Pareja" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td style="padding-left: 1rem">
                                            <table>
                                                <tr class="poblacion-etnica-valor-tipo-vivienda"><td>11,6%</td></tr>
                                                <tr><td>DOS PERSONAS</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td><img src="storage/images/family-three.png" alt="Logo Familia 3" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td style="padding-left: 1rem">
                                            <table>
                                                <tr class="poblacion-etnica-valor-tipo-vivienda"><td>20,9%</td></tr>
                                                <tr><td>TRES PERSONAS</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <table style="width: 100%; margin-bottom: 2rem;">
                        <tr>
                            <td style="width: 32%">
                                <table>
                                    <tr>
                                        <td><img src="storage/images/family-four.png" alt="Logo Familia cuatro" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td style="padding-left: 1rem">
                                            <table>
                                                <tr class="poblacion-etnica-valor-tipo-vivienda"><td>11,6%</td></tr>
                                                <tr><td>CUATRO PERSONAS</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td><img src="storage/images/family-of-six-including-a-baby.png" alt="Logo Hombre" style="width: 3rem; height: 3rem; object-fit: cover; margin-bottom: 0.5rem;"></td>
                                        <td style="padding-left: 1rem">
                                            <table>
                                                <tr class="poblacion-etnica-valor-tipo-vivienda"><td>11,6%</td></tr>
                                                <tr><td>CINCO PERSONAS</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                                </table>
