    ...
    @if ($alert)
        ...
        align-items: center;">
            <div style="font-family:Arial, Helvetica, sans-serif">
                <p>Por Favor aplicar algun valor a Departamento y/o Municipio. Ambos valores son necesarios para el buen funcionamiento de la aplicacion</p>
            </div>
            <div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($configurations as $configuration)
                        <tr style="font-family: sans-serif; font-size: 14px; color: #555;white-space: no-wrap;">
                            ...
                            <td class="px-6 py-4 "> 
                                <x-filament::button color="danger" wire:click="resetValues" style=" font-size: 12px; font-family: sans-serif; letter-spacing: 1px;">
                                    Resetear Valores 
                                </x-filament::button>
                            </td>                           
                        </tr>        
